...
const renderComponent = (element, content) => {
...
const getFormLayout = () => {
  return `<article class="card card--edit card--black card--repeat">
...
// Меню
renderComponent(container, getControlLayout());
...
renderComponent(boardContainer, getFormLayout());
renderComponent(boardContainer, getCardLayout());
renderComponent(boardContainer, getCardLayout());
renderComponent(boardContainer, getCardLayout());

// Кнопка
renderComponent(boardContainer, getButtonLayout());
